...
**Direct fetch dari test-java**: Halaman di `/app/test-java/page.tsx` melakukan panggilan langsung `fetch('http://localhost:8080')`, melanggar prinsip arsitektur. Frontend seharusnya menggunakan route handler Next.js.
