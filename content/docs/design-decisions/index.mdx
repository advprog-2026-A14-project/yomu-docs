...
| Pattern API Routes (Next.js) | Next.js API routes sebagai entry point untuk komunikasi dengan backend | Panggilan langsung frontend → backend | Auth terpusat, pemformatan response, routing terorganisir | Hop ekstra, beban server Next.js |
