...
<Cards>
  <Card
    title="Frontend"
    description="Next.js 16 dengan route handlers, shadcn/ui, dan Google OAuth"
    href="/docs/frontend"
  />
  <Card
...
<Callout type="idea" title="API Routes Pattern">
Frontend Next.js berkomunikasi dengan backend services melalui route handler yang mengelola autentikasi dan cookie.
</Callout>
