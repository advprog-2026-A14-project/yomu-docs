---
title: Java Pipeline
description: Java backend CI/CD — PMD, JaCoCo, OWASP, Docker build, and Heroku deployment
---


The Java backend uses Gradle Kotlin DSL with Java 21 and Spring Boot 4.0.2. The pipeline consists of five workflow files with quality gates for code, security, and Docker artifacts.
